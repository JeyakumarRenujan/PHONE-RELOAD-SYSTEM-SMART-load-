...
namespace GUIGroup17 {
	...
	/// <summary>
	/// Summary for MobitelForm
	/// </summary>
	public ref class MobitelForm : public System::Windows::Forms::Form
	{
	public:
		Form^ objM;
		MobitelForm(void)
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MobitelForm::typeid));
			...
			this->button1->Text = L"Mobitel";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &MobitelForm::button1_Click);
			// 
			// label1
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &MobitelForm::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &MobitelForm::button2_Click);
			// 
			// textBox3
			// 
    ...
    private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (num->Length != 0 && amount->Length != 0 && CardNo->Length != 0) {
			if (num->Length == 10) {
				...
				MessageBox::Show("    Oops! \n\nMobitel No required", "", MessageBoxButtons::OK, MessageBoxIcon::Warning);
			}
		}
		else {
