...
namespace GUIGroup17 {
	...
	/// <summary>
	/// Summary for HutchForm
	/// </summary>
	public ref class HutchForm : public System::Windows::Forms::Form
	{
	public:
		Form^ objH;
		HutchForm(void)
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(HutchForm::typeid));
			...
			this->button1->Location = System::Drawing::Point(30, 137);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(328, 40);
			this->button1->TabIndex = 9;
			this->button1->Text = L"Hutch";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &HutchForm::button1_Click);
			// 
			// label1
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &HutchForm::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &HutchForm::button2_Click);
			// 
			// textBox3
			// 
    ...
    private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (num->Length != 0 && amount->Length != 0 && CardNo->Length != 0) {
			if (num->Length == 10) {
				...
				MessageBox::Show("    Oops! \n\nHutch No required", "", MessageBoxButtons::OK, MessageBoxIcon::Warning);
			}
		}
		else {
